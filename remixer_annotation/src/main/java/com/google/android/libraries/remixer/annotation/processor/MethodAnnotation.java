...
abstract class MethodAnnotation {
  ...
  /**
   * Adds all the code statements necessary to initialize a {@link Variable} that corresponds to the
   * annotation.
   *
   ...
   *     class generated by {@link #generateCallbackClass()}.
   */
