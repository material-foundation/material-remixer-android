...
public class CorrectColorList_RemixerBinder implements RemixerBinder.Binder<CorrectColorList> {
  @Override
  public void bindInstance(CorrectColorList activity) {
  ...
  static class Generated_setColor implements Callback<Integer> {
    private final CorrectColorList activity;

    Generated_setColor(CorrectColorList activity) {
